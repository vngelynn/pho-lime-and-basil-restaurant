              ...
              <div className='relative gap-8 p-12'>
                <div className='space-y-6'>
                  ...
                  <p className='text-stone-600 leading-relaxed'>
                    ...
                    Huntington Beach. Our restaurant blends modern elegance with
                    a warm, inviting atmosphere, serving freshly prepared
                    Vietnamese dishes for an enjoyable dining experience.
                  </p>
                  <div className='pt-4'>
